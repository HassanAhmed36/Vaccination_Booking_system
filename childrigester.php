    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST">
            ...
            <!-- <div class="form-group mt-2">
                    <label class="mb-1 mx-1">vaccine</label>
                    <input type="text" class="form-control" name="c_father" id="subject" required>
                </div> -->
            ...
            <div class="form-group mt-2">
                ...
                <label class="mb-1 mx-1">Child Name</label>
                <input type="text" class="form-control" name="c_name" id="subject" pattern="[A-Za-z ]{3,255}" required >

            </div>
            <div class="form-group mt-2">


                <label class="mb-1 mx-1">Parent Name</label>
                <input type="text" class="form-control" name="c_father" id="subject" pattern="[A-Za-z ]{3,255}"required>

            </div>
            <div class="form-group mt-2">


                <label class="mb-1 mx-1">Age</label>
                <input type="number" class="form-control" name="c_age" id="subject" pattern="[1-9]{3,50}"required>

            </div>
            <div class="form-group mt-2">


                <label class="mb-1 mx-1">Phone Number</label>
                <input type="number" class="form-control" name="c_number" id="subject" pattern="[0-9]{1,11}"required>

            </div>
            <div class="form-group mt-2">


                <label class="mb-1 mx-1">Date Of Birth</label>
                <input type="date" class="form-control" name="c_dob" id="subject" required>

            </div>
            <div class="form-group mt-2">


                <label class="mb-1 mx-1">Gender</label>
