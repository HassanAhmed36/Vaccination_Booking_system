...
if(@$_SESSION['role'] == 1 or @$_SESSION['h_name']  ){
 ...
 ?>
    ...
    <div class="container my-5">
        <h2 class="my-5 text-center" style="color: #124265; font-weight:900;">Vaccination booking Appointment</h2>
        ...
        <div class="col-12 col-md-12">
            <form action="" method="POST">
                ...
                <div class="form-group mt-2">
                    <label class="mb-1 mx-1">hospital</label>
                ...
                <div class="form-group mt-2">
                    ...
                    <select class="form-control" name="vaccine">
                        ...
                        ?>
                        <option value="<?= $row['v_id']?>"><?= $row['v_name']?></option>
