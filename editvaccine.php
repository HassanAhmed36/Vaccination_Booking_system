            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="v_name" value="<?= $row['v_name'] ?>" pattern="[A-Za-z0-9 ]{3,50}" required>
                    <div class="invalid-feedback">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="email">Vaccine Status</label>
                    <input id="" type="number" class="form-control" name="v_status" value="<?= $row['v_status'] ?>" pattern="[A-Za-z0-9 ]{3,50}" required>
                    <div class="invalid-feedback">
                    </div>
                  </div>
